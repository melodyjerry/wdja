<?php
//****************************************************
// WDJA CMS Power by Jetiben.com
// Email: jetiben@hotmail.com
// Web: http://www.wdja.net.cn/
//****************************************************
...
function wdja_cms_module_menu()
{
  global $ngenre;
  $tmpstr = ii_ireplace('module.menu', 'tpl');
  if (!ii_isnull($tmpstr)) return $tmpstr;
  else return wdja_cms_module_list();
}

function wdja_cms_module_content()
{
  global $ngenre;
  $tmpstr = ii_ireplace('module.content', 'tpl');
  if (!ii_isnull($tmpstr)) return $tmpstr;
  else return wdja_cms_module_list();
}
...
function wdja_cms_module()
{
  switch($_GET['type'])
  {
    ...
    case 'index':
      ...
      break;
    case 'menu':
      return wdja_cms_module_menu();
      break;
    case 'content':
      return wdja_cms_module_content();
      break;
    default:
      return wdja_cms_module_index();
      break;
