...
function wdja_cms_admin_manage_config_editdisp()
{
  global $nsaveimages;
...
function wdja_cms_admin_manage_action()
{
  ...
  {
    case 'config':
      wdja_cms_admin_manage_config_editdisp();
      break;
    case 'upload':
      uu_upload_files();
      break;
...
function wdja_cms_admin_manage_config_edit()
{
...
function wdja_cms_admin_manage()
{
  ...
  {
    case 'config':
      return wdja_cms_admin_manage_config_edit();
      break;
    case 'upload':
